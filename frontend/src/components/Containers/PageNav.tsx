...
const PageNav = () => {
	...
	const navContainerClasses = `${themeMode === 'dark' ? 'bg-black/50' : 'bg-white/50'} ${styles.navContainer}`
	const dropdownToggleClasses = `${themeMode === 'dark' ? 'bg-darkGray/50' : 'bg-white/50'}  ${styles.dropdownToggleStyles}`
