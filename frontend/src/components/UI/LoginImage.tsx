...
const LoginImage: FC<{ title: string; content: string }> = ({ title = '', content = '' }) => {
	return (
		<svg width='400' height='672' viewBox='0 0 400 672' fill='none' xmlns='http://www.w3.org/2000/svg'>
			<g clip-path='url(#clip0_1999_244)'>
				<rect width='400' height='672' rx='12' fill='url(#paint0_linear_1999_244)' />
				<g opacity='0.5'>
					<circle cx='22' cy='654' r='179.5' stroke='white' stroke-opacity='0.4' />
					<circle cx='22' cy='654' r='109.5' stroke='white' stroke-opacity='0.6' />
					<circle cx='22' cy='648' r='39.5' stroke='white' stroke-opacity='0.8' />
					<circle cx='22' cy='654' r='249.5' stroke='white' stroke-opacity='0.2' />
					<circle cx='22' cy='654' r='249.5' stroke='white' stroke-opacity='0.2' />
					<circle cx='22' cy='654' r='319.5' stroke='white' stroke-opacity='0.1' />
				</g>
			</g>
			...
			<defs>
				...
				>
					...
					<stop offset='1' stop-color='#4138C2' />
				</linearGradient>
